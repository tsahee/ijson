...
static PyObject* parse_basecoro_iter(PyObject *self)
{
	Py_INCREF(self);
	return self;
}
...
static PyObject* parse_basecoro_iternext(PyObject *self)
{
	Py_RETURN_NONE;
}
...
PyTypeObject ParseBasecoro_Type = {
	...
	.tp_iter = parse_basecoro_iter,
	.tp_iternext = parse_basecoro_iternext,
